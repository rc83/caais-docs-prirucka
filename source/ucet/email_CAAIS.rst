...
Pokud :ref:`lokální administrátor <la_prirucka>` (nebo :ref:`statutární zástupce <sz_prirucka>` v případě LA) při zakládání vašeho účtu neměl k dispozici údaje nutné pro ověření vaší totožnosti, naleznete ve své e-mailové schránce zprávu s předmětem **„Byl vám založen profil v CAAIS“** s odkazem pro ztotožnění svého profilu v CAAIS.

.. admonition:: Poznámka
   :class: note
   
   Pokud jste připojeni v uzavřené síti CMS, můžete místo toho alternativně ztotožnit svůj profil v CAAIS v síti CMS.

Aktivace účtu s nutností ověření totožnosti uživatelem
------------------------------------------------------

.. dropdown:: Postup pro ztotožnění profilu v CAAIS
   :open:
