...
Aby mohl lokální administrátor uživatele přenést, musí mu nejprve statutární zástupce založit v systému účet. Jsou to totiž právě statutární zástupci, tedy hejtmani, starostové, ředitelé různých institucí, kteří jsou o spuštění CAAIS informováni jako první a celý proces zahajují.

Systém nabízí dvě možnosti, jak tento úkon provést. Doporučovanou variantou je vyplnění online formuláře a jeho odeslání do datové schránky CAAIS. Alternativně lze založit nový uživatelský účet v prostředí aplikace CAAIS. Obě možnosti jsou detailně popsány v dalším textu.

Pokud bude statutární zástupce sám působit v roli lokálního administrátora (LA), není nutné o vytvoření účtu LA žádat, protože statutární zástupce má ke správě uživatelů také oprávnění ve stejném rozsahu jako lokální administrátor.

Ve výchozím stavu má každý statutární zástupce v CAAIS vytvořen interní účet, ale tento účet je neaktivní, protože předpokládáme nejvýše jednorázové přihlášení pomocí Identity občana (NIA) nebo účtu z datové schránky (ISDS). Chce-li tedy statutární zástupce aktivovat svůj interní účet CAAIS, musí se nejdříve přihlásit jinou metodou (NIA nebo ISDS), doplnit svou e-mailovou adresu a požádat o reset hesla tlačítkem "Zapomněl jsem heslo". Následně obdrží jednorázový kód a může si nastavit vlastní trvalé heslo. K plnohodnotné práci v roli lokálního administrátora je také nutné přiřadit si k účtu autentizační certifikát, tak jak je popsáno článku pro běžné uživatele .
...
O vytvoření profilu a přidělení role lokálního administrátora můžete požádat i prostřednictvím formuláře a odesláním jeho výstupu datovou schránkou. Pokud se pro takovou možnost rozhodnete, rozklikněte na hlavní stránce CAAIS odkaz Založení LA
...
2. V případě potřeby lze založit i několik lokálních administrátorů najednou. Stačí kliknout na „+ Lokální administrátor“ a ve formuláři se zobrazí další pole. Pokud si založení dalšího administrátora rozmyslíte, stačí kliknout na ikonu popelnice. Nezapomeňte, že všichni takto založení uživatelé budou mít v systému CAAIS roli lokálního administrátora a budou moci spravovat váš subjekt i jeho uživatele.
